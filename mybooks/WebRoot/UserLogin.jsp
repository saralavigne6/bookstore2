...
.head {
  ...
  alert("登录成功");
  _parent.location.href="home.jsp";
  </script>
  </c:if>
  ...
  <c:if test="${requestScope.login eq \"fail\" }">
  <script type="text/javascript">
  alert("请先登录!!!");
  </script>
  </c:if>
...
<div class="content">
       ...
       <div class="login">
        ...
        <input type="text" class="input1" name="username" placeholder="用户名" required="" />
     
        <br> 
        <input type="password" class="input1" name="userpass"  placeholder="密码" required="" />
        
    
        <br> 
      <div class="choose"> 
					<input type="checkbox" class="checkbox" ><p class="p"><span style="color:white;">Remember me ? </span>  <span>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;<a href="ForgetPassword.jsp">Forgot password?</a></span></p>
</div>  
