...
function deleteGoods(goodsname,page){
  ...
  <div id="firpanel">
  <table border="1" width="900px" bordercolor="#2828FF">
  <c:if test="${empty requestScope.list }">
  <tr>
  	<td align="center">
  	<font size="+2" color="#0000ff">没有库存告急商品!!!</font>
  	</td>
  </tr>
  </c:if>
    ...
    <tr>
    	<td align="center" >
    	<a >${list.bookname }&emsp;${list.booknumber }&emsp;${list.price }￥&emsp;
    ...
    <a href="GoodsNumberLow?page=${requestScope.page-1 }">上一页</a>
    </c:if>
    &emsp;&emsp;
    <c:if test="${empty requestScope.down }">
    <a href="GoodsNumberLow?page=${requestScope.page+1 }">下一页</a>
    </c:if>
    </td>
    </tr>
    </c:if>
